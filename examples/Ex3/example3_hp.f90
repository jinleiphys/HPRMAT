!------------------------------------------------------------------------------
! example3_hp.f90 - High-Performance version of Example 3
! 16O+44Ca potential of Rhoades-Brown et al., Phys. Rev. C21 (1980) 2417
!------------------------------------------------------------------------------
program example3_hp
  use rmat_hp_mod
  ...
  write(*,*) '================================================'
  write(*,*) 'HPRMAT Example 3: 16O+44Ca Scattering'
  write(*,*) '================================================'
  ...
  ! ns=number of intervals (ns=1 if propagation is not used)
